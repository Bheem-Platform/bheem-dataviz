...
import { BarChart3, Lock, Mail, ArrowRight, CheckCircle } from 'lucide-react';
...
export function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Step 1: Register with BheemPassport
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50 flex items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md">
        ...
        {/* Register Card */}
        <div className="bg-white/80 backdrop-blur-xl rounded-xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-indigo-700/90 text-white font-semibold rounded-md shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:shadow-indigo-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all mt-6"
            >
              {loading ? (
                <>
